...
class TravelUserAdminEditForm(TravelUserEditForm):   # форма редактирования  travelUser
    class Meta:
        model = TravelUser
        fields = '__all__'                # в форме будут все поля
...
class ListOfCountriesEditForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):   # для оформления элементов в html
